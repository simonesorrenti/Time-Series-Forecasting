...
def build_model(input_shape, output_shape):
    ...
    lstm_4 = tfkl.Bidirectional(tfkl.LSTM(64, return_sequences=False, dropout=0.2, recurrent_dropout=0.2, activation='tanh', kernel_initializer=tfk.initializers.GlorotUniform(seed=seed), 
                               kernel_regularizer=tf.keras.regularizers.l2(1e-5)))(skip)
    
    norm = tfkl.BatchNormalization()(lstm_4)
    repeat = tfkl.RepeatVector(864)(norm)
    
    skip = tfkl.Add()([lstm_1,lstm_2, lstm_3, lstm_4, repeat])
    lstm_5 = tfkl.Bidirectional(tfkl.LSTM(64, return_sequences=True, dropout=0.2, recurrent_dropout=0.2, activation='tanh', kernel_initializer=tfk.initializers.GlorotUniform(seed=seed), 
                               kernel_regularizer=tf.keras.regularizers.l2(1e-5)))(skip)
    skip = tfkl.Add()([lstm_1,lstm_2, lstm_3, lstm_4, lstm_5, repeat])
    lstm_6 = tfkl.Bidirectional(tfkl.LSTM(64, return_sequences=True, dropout=0.2, recurrent_dropout=0.2, activation='tanh', kernel_initializer=tfk.initializers.GlorotUniform(seed=seed), 
                               kernel_regularizer=tf.keras.regularizers.l2(1e-5)))(skip)
    skip = tfkl.Add()([lstm_1,lstm_2, lstm_3, lstm_4, lstm_5, lstm_6, repeat])
    lstm_7 = tfkl.Bidirectional(tfkl.LSTM(64, return_sequences=True, dropout=0.2, recurrent_dropout=0.2, activation='tanh', kernel_initializer=tfk.initializers.GlorotUniform(seed=seed), 
                               kernel_regularizer=tf.keras.regularizers.l2(1e-5)))(skip)
    
    skip = tfkl.Add()([lstm_1,lstm_2, lstm_3, lstm_4, lstm_5, repeat, lstm_6, lstm_7])
