...
def build_model(input_shape, output_shape):
    ...
    lstm = tfkl.Bidirectional(tfkl.LSTM(150, return_sequences=False, dropout=0.2, recurrent_dropout=0.2, activation='tanh', kernel_initializer=tfk.initializers.GlorotUniform(seed=seed), 
                               kernel_regularizer=tf.keras.regularizers.l2(1e-5)))(skip)
