...
def build_model(input_shape, output_shape):
    ...
    encoder_outputs, forward_h, forward_c, backward_h, backward_c, *_ = tfkl.Bidirectional(tfkl.LSTM(n_hidden, activation='tanh', dropout=0.2, recurrent_dropout=0.2,
                                                                 return_sequences=False, return_state=True))(input_train)

    encoder_states = [forward_h, forward_c, backward_h, backward_c]

    #forward_h = tfkl.BatchNormalization()(forward_h) 

    decoder = tfkl.RepeatVector(y_train.shape[1])(encoder_outputs)
